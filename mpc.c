...
mpc_parser_t *mpca_grammar_st(const char *grammar, mpca_grammar_st_t *st) {
  ...
  mpc_define(
      Grammar,
      mpc_and(2, mpcaf_grammar_or, Term,
...
static mpc_err_t *mpca_lang_st(mpc_input_t *i, mpca_grammar_st_t *st) {
  ...
  mpc_define(
      Stmt, mpc_and(5, mpca_stmt_afold, mpc_tok(mpc_ident()),
                    mpc_maybe(mpc_tok(mpc_string_lit())), mpc_sym(":"), Grammar,
                    mpc_sym(";"), free, free, free, mpc_soft_delete));
